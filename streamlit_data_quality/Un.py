            ...
            if  selected_choices == "Data Quality":#Data quality module
                        ...
                        for i in box:
                            ...
                            if selection == i and selection not in word:
                                ...
                                with tab1:
                                    ...
                                    pie_plot.set_ylabel('Counts', size=11)
                                    st.pyplot(fig)
                ...
                for i in box:  
                    if select is not None :
                            ...
                            if df[i].isnull().sum()==len(df[i]):
                                ...
                                if check_int:
                                    ...
                                    if st.button("Error Result"):
                                        st.warning("Please don't click error result multiple times, the result of error result will accumulate and affect the calculation of validaiton score")
                        ...
                        score=round(final_accuracy*accuracys_weight*100)+completeness_weight*round(100*(1-sum(st.session_state["type"])/len(df)))+round(100*(1-sum(st.session_state["validation"])/len(df)))*validation_weight
                        ...
                        if st.button("Final Score"):
                            ...
                            st.write("Completeness :",round(100*(1-sum(st.session_state["type"])/len(df))))
